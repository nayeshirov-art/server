class AppConstants {
  ...
  static const Map<String, String> reciters = {
    ...
    'ar.yasseraldossary':    'ياسر الدوسري',
    ...
    'ar.nasser.alqatami':    'ناصر القطامي',
    'ar.abdullahibnalbanna': 'عبدالله بن بنا',
  };
  ...
  static const Map<String, String> recitersFr = {
    ...
    'ar.yasseraldossary':    'Yasser Al-Dossari',
    ...
    'ar.nasser.alqatami':    'Nasser Al-Qatami',
    'ar.abdullahibnalbanna': 'Abdullah Ibn Al-Banna',
  };
}
